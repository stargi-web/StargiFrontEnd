...
export const routesnew: Routes = [
  ...
  // Rutas de oportunidades
  {
    ...
    children: [
      ...
      { path: 'create', component: ExecutiveCreateOpportunityComponent },
      { path: 'team', component: SupervisorTeamOpportunitiesComponent },
      { path: 'all', component: AdminViewAllOpportunitiesComponent },
      {
